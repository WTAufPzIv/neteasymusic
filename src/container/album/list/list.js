    ...
    render = () => {
        return (
            <div className = 'album_list_body'>
                ...
                {
                    this.props.get_album_detail === true && this.props.get_user_like_music === true?this.props.album_detail_data.songs.map((item,index) => {
                        return (
                            <div className = 'album_list__item' style = {{'backgroundColor':index%2!==0?'rgb(33,33,33)':''}}>
